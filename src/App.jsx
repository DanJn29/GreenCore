  ...
  AM: {
    ...
    products: {
      ...
      cards: {
        ...
        peach: [
          { title: "Թարմ դեղձ", description: "Հյութալի և անուշահամ դեղձ՝ անմիջապես այգուց:" },
          { title: "Արտահանում", description: "Պրեմիում դասի փաթեթավորում արտահանման համար:" },
          { title: "Մեծածախ մատակարարում", description: "Կայուն մատակարարումներ սեզոնի ողջ ընթացքում:" },
        ],
        nectarine: [
          { title: "Թարմ նեկտարին", description: "Բարձրորակ նեկտարին՝ մշակված նորագույն տեխնոլոգիաներով:" },
          { title: "Արտահանում", description: "Միջազգային ստանդարտներին համապատասխան որակ:" },
          { title: "Մեծածախ մատակարարում", description: "Ճկուն համագործակցության պայմաններ:" },
        ],
      },
    },
    process: {
  ...
  EN: {
    ...
    products: {
      ...
      cards: {
        ...
        peach: [
          { title: "Fresh Peach", description: "Juicy and delicious peaches straight from the orchard." },
          { title: "Export", description: "Premium class packaging for international export." },
          { title: "Wholesale Supply", description: "Stable supply throughout the entire season." },
        ],
        nectarine: [
          { title: "Fresh Nectarine", description: "High-quality nectarines grown with the latest technology." },
          { title: "Export", description: "Quality meeting international standards." },
          { title: "Wholesale Supply", description: "Flexible cooperation terms for our partners." },
        ],
      },
    },
    process: {
  ...
  RU: {
    ...
    products: {
      ...
      cards: {
        ...
        peach: [
          { title: "Свежий персик", description: "Сочные и ароматные персики прямиком из сада." },
          { title: "Экспорт", description: "Упаковка премиум-класса для международного экспорта." },
          { title: "Оптовые поставки", description: "Стабильные поставки в течение всего сезона." },
        ],
        nectarine: [
          { title: "Свежий нектарин", description: "Высококачественные нектарины, выращенные с применением новейших технологий." },
          { title: "Экспорт", description: "Качество, соответствующее международным стандартам." },
          { title: "Оптовые поставки", description: "Гибкие условия сотрудничества для наших партнеров." },
        ],
      },
    },
    process: {
...
const fruitAssets = {
  ...
  peach: {
    productImages: [
      "/assets/photos/ProductImagepeach3.png",       // PLACEHOLDER: Change to peach photo
      "/assets/photos/product-export.jpg",           // PLACEHOLDER: Change to peach photo
      "/assets/photos/product-wholesale.jpg"         // PLACEHOLDER: Change to peach photo
    ],
    processImages: [
      "/assets/photos/process-winter-pruning.png",   // Step 1
      "/assets/photos/process-spring-growth.png",    // Step 2
  ...
  nectarine: {
    productImages: [
      "/assets/photos/product-fresh-figs.png",       // PLACEHOLDER: Change to nectarine photo
      "/assets/photos/product-export.jpg",           // PLACEHOLDER: Change to nectarine photo
      "/assets/photos/product-wholesale.jpg"         // PLACEHOLDER: Change to nectarine photo
    ],
    processImages: [
      "/assets/photos/process-winter-pruning.png",   // Step 1
      "/assets/photos/process-spring-growth.png",    // Step 2
